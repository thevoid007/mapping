    ...
    <aside class="side-panel" id="sidePanel">
        ...
        <section class="tab-panel active" id="tab-planner">
            ...
            <form id="pointForm" autocomplete="off" novalidate>
                <div class="route-mgr">
                    <div class="route-mgr-head">
                        <span class="route-mgr-title">Rute Aktif</span>
                        <button type="button" class="btn btn-ghost btn-sm" id="btnAddRoute">＋ Tambah Rute</button>
                    </div>
                    <div id="routeTabs" class="route-tabs"></div>
                </div>
...
<template id="pointRowTemplate">
    <div class="point-row" draggable="true">
        <div class="point-main">
            ...
            <input type="text" class="point-input" placeholder="Masukkan nama lokasi atau koordinat..." aria-label="Nama lokasi" required maxlength="255">
            <span class="point-status"></span>
            <button type="button" class="icon-btn focus-btn" title="Fokus ke area titik ini">◎</button>
        ...
        <div class="point-fields">
            <label class="field-group">
                ...
                <input type="number" class="field-input radius-input" value="300" min="1" step="10" placeholder="m">
                <span class="field-unit">m</span>
            </label>
            <label class="field-group">
                <span class="field-label">Az</span>
                <input type="number" class="field-input azimuth-input" value="0" min="0" max="360" step="1" placeholder="°">
                <span class="field-unit">°</span>
            </label>
            <label class="field-group">
                <span class="field-label">Bw</span>
                <input type="number" class="field-input beam-input" value="360" min="1" max="360" step="1" placeholder="°">
                <span class="field-unit">°</span>
            </label>
        </div>
        <div class="point-error" hidden></div>
    </div>
</template>
